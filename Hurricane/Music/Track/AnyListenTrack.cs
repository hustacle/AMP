...
namespace Hurricane.Music.Track
{
    public class AnyListenTrack : StreamableBase
    {
        ...
        public override string Link => SongResult.CopyUrl;
        public override string Website => "http://www.itwusun.com";
        public override bool IsInfinityStream => false;

        public override string DownloadParameter => CommonHelper.GetDownloadUrl(SongResult, HurricaneSettings.Instance.Config.DownloadBitrate,
